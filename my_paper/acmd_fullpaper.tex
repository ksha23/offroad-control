...
neural stack cuts mean RMS crosstrack error by $\approx$58\% versus SCM-calibrated
...
conditioning the surrogate on the live terrain estimate (\S\ref{sec:est})
recovers most of the matched-prior benefit with no prior terrain knowledge.
...
surrogate-plus-estimator recovers most of the matched-prior benefit with no
prior terrain knowledge; the fused proprioceptive-force UKF tracks the sinkage
exponent to 3.8\% median error; the DOB-CBF filter cuts collisions by 88\% under a learned
