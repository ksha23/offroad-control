...
plant is Chrono::Vehicle from the open-source Project Chrono multi-physics
engine, driven by a synthetic 5G
...
(Project Chrono~\cite{Tasora16,Serban19}), the same ROS~2 / Chrono::ROS
messaging substrate, and
...
multi-physics engine~\cite{Tasora16,Serban19}, simulates
an HMMWV on a Soil Contact Model (SCM)~\cite{Krenn09} patch; the
human-in-the-loop evaluation is inspired by Chrono::HIL~\cite{Zhou23}. The
...
This work is inspired by the Chrono::HIL framework~\cite{Zhou23} and built on
the open-source Project Chrono multi-physics engine~\cite{Tasora16,Serban19,Krenn09}.
The 5G traffic profile is
