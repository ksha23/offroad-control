...
calibration is acceptable at the two soft-soil presets paper118
reports but does not generalise to a broad LHS sweep; the surrogate
instead natively predicts what the *whole vehicle*
produces:
\[
